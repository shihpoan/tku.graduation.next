...
export default function Home() {
  ...
  const [randomNum, setRandomNum] = useState([0, 0, 0, 1, 2, 3, 4]);
  ...
  useEffect(() => {
    console.log("changed");
    // ran
    const _bgIndex = Math.floor(Math.random() * 4);
    const _blessingIndex = Math.floor(Math.random() * 4);
    const _prevBlessingIndex = Math.floor(Math.random() * 4);
    const _student1Index = Math.floor(Math.random() * 7000);
    const _student2Index = Math.floor(Math.random() * 7000);
    const _student3Index = Math.floor(Math.random() * 7000);
    const _student4Index = Math.floor(Math.random() * 7000);
  ...
  useEffect(() => {
    const _bg = bgArr[randomNum[0]];
    setIsChangeBg(_bg);
    const _prevBlessing = `${jsonData[randomNum[3]]?.name}祝:${
      jsonData[randomNum[4]]?.name
    }${blessings[randomNum[2]]}`;
    setIsPrevChangeText(_prevBlessing);
    const _blessing = `${jsonData[randomNum[5]]?.name}祝:${
      jsonData[randomNum[6]]?.name
    }${blessings[randomNum[1]]}`;
    setIsChangeText(_blessing);
  }, [randomNum, blessings, jsonData, bgArr]);
